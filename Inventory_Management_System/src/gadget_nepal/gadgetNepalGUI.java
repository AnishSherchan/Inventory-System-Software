 ...
 * @author sherc
 */
public class gadgetNepalGUI extends javax.swing.JFrame {
    ArrayList al;
    ...
    private void initComponents() {
        ...
        Generate_Lable.setText("Generate Report");
    ...
    //Method for notifying the user after submitting their details and message
    private void Add_Lable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add_Lable2MouseClicked
        if(jTextField3.getText().trim().isEmpty() ||  jTextField7.getText().trim().isEmpty()  || jTextArea1.getText().trim().isEmpty()){
            new NoticeWindow(NoticeType.WARNING_NOTIFICATION,"Please fill all the text fields",NoticeWindow.SHORT_DELAY,NPosition.BOTTOM_RIGHT);
        }
        else{
    ...
    //Method for executing addition functionality in the program
    private void addButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addButtonMouseClicked
        ...
        //Checking if the text fields, radio buttons and combo box have empty or default values       
        if(idTextField.getText().trim().isEmpty() || category == "SELECT" || nameTextField.getText().trim().isEmpty() || rangeSelector == 0 || priceTextField.getText().trim().isEmpty()){
            ...
            if(isNumeric == true && priceNumericCheck == true){
                //Checking product ID repetition 
                ...
                if(repeated){
                    ...
                    //Creating an object of the entered details to add on the table model
                    ...
                    totalItem();
                    //Notification after successful detail addition
        ...
        //Calling clear method to reset the text fields, radio button and combo box
        clear();
    }//GEN-LAST:event_addButtonMouseClicked

    //Method for displaying total number of items on the label
    ...
    //Method for executing search operation
    private void searchBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchBtnMouseClicked
        ...
        if(isNumeric == true){
            ...
            for(int i = 0; i<al.size();i++){
                ...
                sortedPriceArray.add(tempal.get(4));
            }
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        if(jTable1.getRowCount()== 0 && jTable2.getRowCount()== 0){
            ...
            int Select = JOptionPane.showConfirmDialog(this, "Your Current File will be Lost, Export it!! Do you still Want to Continue?","Confirm",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
    ...
    //Method for updating the details of the table
    ...
    //Method to search for the details on the basis of category
    private void searchBtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchBtn1MouseClicked
        try{
            ...
            //removing previous details on the search table
            ...
            for(int i = 0; i < jTable1.getRowCount(); i++){
                ...
                //Comparing the category in the table with the category provided by the user
                if(searchingCategory.equals(tableCategory)){
                    count=count+1;
                    //Adding searched details on the basis of category to the search table
            ...
            //Fetching and assembling all the product names in searched category 
            String data = "";
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        File file = new File("src/Help/UserManual.pdf");
        try {
    ...
    private static Font createFont(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_Path))
                .deriveFont(80,26f);
    ...
    private static Font createFontmenu(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_menu))
                .deriveFont(80,12f);
    }
    ...
    private static Font createFontNav(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_PathNav))
                .deriveFont(80,16f);
    ...
    private static Font createFontHeading(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_PathHeading))
                .deriveFont(80,20f);
    ...
    private static Font createFontHeadingSub(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_PathSub))
                .deriveFont(50,1f);
    ...
    private static Font createFontTextfield(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_Path01))
                .deriveFont(80,18f);
    ...
    private static Font createFonttabhea(String url) throws FontFormatException, IOException{
        ...
        return Font.createFont(Font.TRUETYPE_FONT,gadgetNepalGUI.class.getClassLoader().getResourceAsStream(Font_Pathtabhe))
                .deriveFont(80,16f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gadgetNepalGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gadgetNepalGUI().setVisible(true);
            }
        });
    }
